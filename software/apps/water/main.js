  ...
  function duringDrag(x, y) {
    ...
    switch (mode) {
      ...
      case MODE_MOVE_SPHERE: {
        ...
        console.log("BEFORE function duringDrag case MODE_MOVE_SPHERE  center.x: " + center.x + "  center.y: " + center.y + "  center.z: " + center.z);
...
/******************************** MANUALLY ADD ABSOLUTE POSITION COORDINATES ************************/
        if(haveBluetoothConnection){
            ...
            console.log("ABSOLUTE POSITION  center.x: " + newCenterX + "  center.y: " + newCenterY + "  center.z: " + newCenterZ);
        ...
        console.log("function duringDrag case MODE_MOVE_SPHERE  center.x: " + center.x + "  center.y: " + center.y + "  center.z: " + center.z);
...
**************************************************************************************************/
  ...
  function applyAbsolutePosition(){
    ...
    if(havePosition && haveBluetoothConnection){

        newPageX = (xCoordinate / 100) * gl.canvas.width;
        newPageY = ((100 - yCoordinate) / 100) * gl.canvas.height;
        newPageZ = (zCoordinate / 100) * gl.canvas.height;

     //   startDrag(e.pageX, e.pageY);
        startDrag(newPageX, newPageY);
