...
#define MLX90615_I2CADDR6         0x3B     //0x2F not working
#define MLX90615_I2CADDR7         0x30
#define MLX90615_I2CADDR8         0x31
#define MLX90615_I2CADDR9         0x32
#define MLX90615_I2CADDR10        0x33
#define MLX90615_I2CADDR11        0x34
#define MLX90615_I2CADDR12        0x35
#define MLX90615_I2CADDR13        0x36
#define MLX90615_I2CADDR14        0x37
#define MLX90615_I2CADDR15        0x38
#define MLX90615_I2CADDR16        0x39
#define MLX90615_I2CADDR17        0x3A
...
{     
 ...
 if(clocktime + speedMs < millis()){
  ...
  //  if(blueLED_timer > clocktime){ digitalWrite(BLUE_LED_PIN, 0); } else { digitalWrite(BLUE_LED_PIN, 1); }}
   ...
   /*********************** VL5310X Distance READ **************************/    
    if(debug){ Serial.println("Reading VL53L0X Distance... "); Serial.print("Distance (mm): "); }
    float distance_1 = 9999;
    VL53L0X_RangingMeasurementData_t measure;
    vl53l0x_1.rangingTest(&measure, false); // pass in 'true' to get debug data printout!
  
    if (measure.RangeStatus != 4) {  // phase failures have incorrect data
      distance_1 = (float)measure.RangeMilliMeter;
      if(debug){ Serial.println(distance_1); }
    } else {
